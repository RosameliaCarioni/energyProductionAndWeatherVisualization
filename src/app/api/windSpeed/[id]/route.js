/**
 * Retrieves a location based on the provided ID.
 *
 * @param {Object} req - The request object.
 * @param {Object} params - The route parameters.
 * @param {string} params.id - The ID of the farm for which we want to see the wind.
 *
...
export async function GET(req, { params }) {
  try {
    const location = wind_speed.data.filter(item => item.id === params.id)
