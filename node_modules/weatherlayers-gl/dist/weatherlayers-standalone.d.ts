...
declare function getRasterImage(imageProperties: ImageProperties, palette: Palette): HTMLCanvasElement;
...
declare function getContourLines(imageProperties: ImageProperties, bounds: GeoJSON.BBox, interval: number): Promise<GeoJSON.FeatureCollection<GeoJSON.LineString, ContourLineProperties>>;

interface ContourLabelProperties {
    value: number;
    angle: number;
}
declare function getContourLabels(contourLines: GeoJSON.Feature<GeoJSON.LineString, ContourLabelProperties>[]): GeoJSON.Feature<GeoJSON.Point, ContourLabelProperties>[];
...
declare function getHighLowPoints(imageProperties: ImageProperties, bounds: GeoJSON.BBox, radius: number): Promise<GeoJSON.FeatureCollection<GeoJSON.Point, HighLowPointProperties>>;
